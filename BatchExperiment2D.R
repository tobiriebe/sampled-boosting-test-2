...
reg = makeExperimentRegistry(id = "mytest2D", packages = c("mlr", "BatchJobs", "BatchExperiments",
...
#Add the problem
addProblem(reg, id = "mytest2D", dynamic = data, seed = 123, overwrite = TRUE)
...
addExperiments(reg, prob.designs = mytest2D.design,
